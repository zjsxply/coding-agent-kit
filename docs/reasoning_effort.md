...
Status in this table was verified against official CLI docs on **February 9, 2026**.
...
| `cursor` | Not supported | No reasoning effort or thinking toggle in cursor-agent CLI docs |
| `copilot` | Not supported | No reasoning effort or thinking toggle in Copilot CLI docs |
| `gemini` | Not supported | No reasoning effort or thinking toggle in Gemini CLI headless flags |
...
| `openhands` | Not supported | No per-run reasoning effort flag in OpenHands headless CLI docs |
| `swe-agent` | Not supported | No per-run reasoning effort flag in SWE-agent CLI docs |
| `trae-oss` | Not supported | No per-run reasoning effort flag in Trae CLI docs |
